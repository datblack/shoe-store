app.controller('order-ctrl', function ($scope, $http, $window, $rootScope, $timeout) {
    ...
    const API_PRODUCT_VARIANT = 'http://localhost:8080/admin/rest/product-variants';
    const API_VARIANT_VALUE = 'http://localhost:8080/admin/rest/variant-values';
    const API_BILL = 'http://localhost:8080/admin/rest/bills';
    const API_BILL_DETAIL = 'http://localhost:8080/admin/rest/bill-details';
    const API_USER = 'http://localhost:8080/admin/rest/users';
    const API_SALE = 'http://localhost:8080/admin/rest/sales';
    const API_DOWNLOAD_QR_CODE = 'http://localhost:8080/download-QRCode/bill';
    const API_PDF_BILL = 'http://localhost:8080/pdf/print';
    const API_SETTING = 'http://localhost:8080/admin/rest/settings/get-district-id-store';
    const API_VNPAY = 'http://localhost:8080/api/vnpay';
