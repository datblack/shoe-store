app.controller('product-ctrl', function ($scope, $http, $rootScope) {
    ...
    const productApi = "http://localhost:8080/admin/rest/products";
    const producOptiontApi = "http://localhost:8080/admin/rest/product-options";
    const optionValueAPI = "http://localhost:8080/admin/rest/option-values";
    const productVariantAPI = 'http://localhost:8080/admin/rest/product-variants';
    const variantValueApi = 'http://localhost:8080/admin/rest/variant-values'
    const imageApi = 'http://localhost:8080/admin/rest/image';
    const API_OPTION = 'http://localhost:8080/admin/rest/options';
    const API_QR_CODE = 'http://localhost:8080/admin/rest/genarate-QRCode';
    const API_DOWNLOAD_EXCEL = 'http://localhost:8080/admin/rest/excel';
    const API_SEND_MAIL = 'http://buiquanghieu.xyz/TestSendMail/get-all-file/product';
    const productOptionApi = 'http://localhost:8080/admin/rest/product-options';
